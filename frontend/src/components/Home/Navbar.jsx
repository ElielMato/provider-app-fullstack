            ...
            <div className="container mx-auto flex items-center justify-between">
                ...
                </ul>
                {
                    user.logged === true && user.role === 'user' ? (
                        ...
                        <div className="flex space-x-4">
                            <Link className="text-sm px-3 py-2 bg-indigo-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2 no-underline" to="/login">
                            ...
                            <Link className="text-sm px-3 py-2 bg-indigo-500 hover:bg-indigo-600 text-gray-50 rounded-xl flex items-center gap-2 no-underline" to="/register">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
